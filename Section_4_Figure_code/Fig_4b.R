...
FeaturePlot(tcell, reduction = 'umap', features = "MA0511.2", order = F, cols = c('grey80',"#D4524E")) + #NoAxes() +
  ...
  theme_bw() + ggtitle("") + theme(panel.border = element_rect(colour = "black", fill=NA, size=0)) +
